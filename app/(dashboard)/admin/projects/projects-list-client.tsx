            ...
            <div className="space-y-2">
              {filteredProjects.map((project, index) => (
                <motion.div
                  ...
                  className="flex flex-col sm:flex-row items-start gap-4 p-4 rounded-xl hover:bg-secondary/50 transition-colors"
                >
                  <div className="relative w-16 h-16 rounded-lg overflow-hidden shrink-0 sm:shrink-0">
                    {project.cover_image ? (
                      <Image
                  ...
                  <div className="flex-1 min-w-0 w-full text-left">
                    ...
                    <div className="flex flex-wrap items-center justify-start gap-2 mt-1.5">
                      ...
                      <span className="text-xs px-2 py-1 rounded-full bg-surface-alt text-foreground-muted hidden sm:inline">
                        {project.created_at
                      ...
                      {project.featured && (
                        <span className="text-xs px-2 py-0.5 rounded-full bg-champagne/40 text-foreground items-center gap-1 hidden sm:flex">
                  ...
                  <div className="flex items-center gap-1.5 shrink-0 justify-start sm:justify-end w-full sm:w-auto">
                    <Tooltip>
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button
                          size="sm"
                          variant="outline"
                          className="text-destructive border-destructive/30 hover:bg-destructive/10 min-w-9 min-h-9 sm:min-w-10 sm:min-h-10"
